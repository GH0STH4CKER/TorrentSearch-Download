        ...
        if resps.status_code == 200 :
            ...
            if choice2 == "1" :                               # Download direct method (.torrent)  
                ...
                headers = {
                    ...
                    "cookie": "__cfduid=dc9dbfced543b9b69324efcf342c102461597052076; _ga=GA1.2.637768875.1597052076; _gid=GA1.2.1336385825.1597052076; _gat=1",
                ...
                r = requests.get(direct_link,headers=headers)
                saveNM = saveNM + ".torrent"
                if r.status_code == 200 :
                    open(saveNM, 'wb').write(r.content)   # Saving file 
                    print("\nSaved Successfully > check user folder ")
                    print("ex- C:/Users/ghosthacker/ ")
                else:
